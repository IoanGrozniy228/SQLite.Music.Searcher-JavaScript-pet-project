...
- **Authors** — авторы (имя, год начала карьеры, фото)
...
- **Favorites** — избранное (связь пользователь ↔ песня)

Сейчас в базе: Michael Jackson, Queen, Guns N' Roses, Travis Scott. Скоро можно будет добавить новых через API.
## 📡 API
...
- Auth rate limiting: 5 попыток / 1 минута на логин и регистрацию
